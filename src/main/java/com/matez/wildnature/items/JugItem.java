...
public class JugItem extends Item {
   public JugItem(Item.Properties builder) {
      super(builder);
   }
         ...
         if (raytraceresult.getType() == RayTraceResult.Type.MISS) {
            ...
            if (raytraceresult.getType() == RayTraceResult.Type.BLOCK) {
               ...
               if (worldIn.getFluidState(blockpos).isTagged(FluidTags.WATER)) {
                  ...
                  return new ActionResult<>(ActionResultType.SUCCESS, this.turnBottleIntoItem(itemstack, playerIn, PotionUtils.addPotionToItemStack(new ItemStack(Main.getItemByID("wildnature:jug_water")), Potions.WATER)));
               }
            }
