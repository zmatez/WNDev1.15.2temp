...
public class LavalilyItem extends BlockItem {
   public Block block;
   public LavalilyItem(Block blockIn, Properties builder) {
   ...
   public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
      ...
      if (raytraceresult.getType() == RayTraceResult.Type.MISS) {
         ...
         if (raytraceresult.getType() == RayTraceResult.Type.BLOCK) {
            ...
            if ((ifluidstate.getFluid() == Fluids.LAVA || material == Material.LAVA) && worldIn.isAirBlock(blockpos1)) {
