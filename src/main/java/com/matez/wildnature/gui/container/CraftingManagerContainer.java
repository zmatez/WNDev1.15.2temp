...
public class CraftingManagerContainer extends RecipeBookContainer<CraftingInventory> {
   ...
   public CraftingManagerContainer(int p_i50089_1_, PlayerInventory p_i50089_2_) {
      this(p_i50089_1_, p_i50089_2_, IWorldPosCallable.DUMMY);
   }

   public CraftingManagerContainer(int p_i50090_1_, PlayerInventory p_i50090_2_, IWorldPosCallable p_i50090_3_) {
