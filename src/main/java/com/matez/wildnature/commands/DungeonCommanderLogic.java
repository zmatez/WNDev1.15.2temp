...
public abstract class DungeonCommanderLogic extends CommandBlockLogic {
   ...
   public boolean tryOpenEditCommandBlock(PlayerEntity playerIn) {
      if (!playerIn.canUseCommandBlock()) {
         ...
         if (playerIn.getEntityWorld().isRemote) {
            //Minecraft.getInstance().displayGuiScreen(new DungeonCommanderScreen((DungeonCommanderTileEntity)tileentity));
