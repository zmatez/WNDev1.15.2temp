...
public class UnderwaterDoubleBushBase extends DoubleBushBase implements ILiquidContainer, IShearable {
    public UnderwaterDoubleBushBase(Properties properties, Item.Properties builder, ResourceLocation regName) {
