...
public class LeverBase extends LeverBlock implements IRenderLayer {
    private Item item;
    ...
    public LeverBase(Properties properties, Item.Properties builder, ResourceLocation regName) {
