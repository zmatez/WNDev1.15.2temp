...
public class CakeBase extends Block implements IRenderLayer {
   ...
   public Item item;
   public CakeBase(Properties properties, Item.Properties builder, ResourceLocation regName) {
      super(properties);
   ...
   /**
    * @deprecated call via {@link} whenever possible.
