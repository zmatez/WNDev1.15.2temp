...
public class PressurePlateBase extends AbstractPressurePlateBlock implements IRenderLayer {
    public static final BooleanProperty POWERED = BlockStateProperties.POWERED;
    private final PressurePlateBlock.Sensitivity sensitivity;
    private Item item;
    public PressurePlateBase(PressurePlateBlock.Sensitivity p_i48348_1_, Properties properties, Item.Properties builder, ResourceLocation regName) {
        super(properties);
