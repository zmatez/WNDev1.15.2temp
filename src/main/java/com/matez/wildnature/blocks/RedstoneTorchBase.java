...
public class RedstoneTorchBase extends RedstoneTorchBlock implements IRenderLayer {
    ...
    public RedstoneTorchBase(Properties properties, ResourceLocation regName) {
