...
public class LanternBase extends BlockBase  implements IRenderLayer {
   ...
   public LanternBase(Properties properties, Item.Properties builder, ResourceLocation regName) {
      super(properties, builder, regName);
      this.setDefaultState(this.stateContainer.getBaseState().with(HANGING, Boolean.valueOf(false)));

   }

   public LanternBase(Properties properties, Item.Properties builder, String drop, int min, int max, int exp, ResourceLocation regName) {
   ...
   /**
    * @deprecated call whenever possible. Implementing/overriding is fine.
    */
