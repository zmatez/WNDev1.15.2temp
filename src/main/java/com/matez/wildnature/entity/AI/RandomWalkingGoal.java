...
public class RandomWalkingGoal extends Goal {
   ...
   private int xzf=10, yf=7;


   public RandomWalkingGoal(CreatureEntity creatureIn, double speedIn) {
      this(creatureIn, speedIn, 120,10,7);
   }

   public RandomWalkingGoal(CreatureEntity creatureIn, double speedIn, int chance, int xz, int y) {
   ...
   protected Vec3d getPosition() {
      return RandomPositionGenerator.findRandomTarget(this.creature, xzf, yf);
   }
