...
public class DuckModel extends EntityModel<DuckEntity> {
	...
	public DuckModel() {
		...
		RightLeg3.setTextureOffset(0, 29).addBox(-2.0F, 3.0F, -4.0F, 2.0F, 0.0F, 3.0F, 0.0F, false);
		...
		LeftLeg3.setTextureOffset(0, 29).addBox(-1.0F, 3.0F, -4.0F, 2.0F, 0.0F, 3.0F, 0.0F, false);
	...
	@Override
	public void setRotationAngles(DuckEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
