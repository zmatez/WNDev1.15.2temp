...
@OnlyIn(Dist.CLIENT)
public class FuzzballExplosionParticle extends SpriteTexturedParticle {
   private FuzzballExplosionParticle(World p_i51046_1_, double p_i51046_2_, double p_i51046_4_, double p_i51046_6_, double p_i51046_8_, double p_i51046_10_, double p_i51046_12_, boolean p_i51046_14_) {
...
*/
   ...
   public static class Factory implements IParticleFactory<BasicParticleType> {
      ...
      public Particle makeParticle(BasicParticleType typeIn, World worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
         FuzzballExplosionParticle fuzz = new FuzzballExplosionParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, false);
         fuzz.setAlphaF(0.95F);
         fuzz.selectSpriteRandomly(this.spriteSet);
         return fuzz;
      }
   }
