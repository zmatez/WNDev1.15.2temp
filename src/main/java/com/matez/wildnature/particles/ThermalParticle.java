...
@OnlyIn(Dist.CLIENT)
public class ThermalParticle extends SpriteTexturedParticle {
   private ThermalParticle(World p_i51046_1_, double p_i51046_2_, double p_i51046_4_, double p_i51046_6_, double p_i51046_8_, double p_i51046_10_, double p_i51046_12_, boolean p_i51046_14_) {
...
*/
   ...
   @OnlyIn(Dist.CLIENT)
   public static class ThermalParticleFactory implements IParticleFactory<BasicParticleType> {
      private final IAnimatedSprite spriteSet;

      public ThermalParticleFactory(IAnimatedSprite p_i51180_1_) {
         this.spriteSet = p_i51180_1_;
      }

      public Particle makeParticle(BasicParticleType typeIn, World worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
         ThermalParticle thermal = new ThermalParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, false);
         thermal.setAlphaF(0.95F);
         thermal.selectSpriteRandomly(this.spriteSet);
         return thermal;
      }
   }
