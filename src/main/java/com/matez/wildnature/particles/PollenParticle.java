...
public class PollenParticle extends SpriteTexturedParticle {
    ...
    private PollenParticle(World p_i51033_1_, double p_i51033_2_, double p_i51033_4_, double p_i51033_6_, float p_i51033_8_, float p_i51033_9_, float p_i51033_10_, IAnimatedSprite p_i51033_11_) {
    ...
    public static class Factory implements IParticleFactory<BlockParticleData> {
        ...
        public Particle makeParticle(BlockParticleData p_199234_1_, World p_199234_2_, double p_199234_3_, double p_199234_5_, double p_199234_7_, double p_199234_9_, double p_199234_11_, double p_199234_13_) {
            ...
            if (!lvt_15_1_.isAir() && lvt_15_1_.getRenderType() == BlockRenderType.INVISIBLE) {
                ...
                return new PollenParticle(p_199234_2_, p_199234_3_, p_199234_5_, p_199234_7_, lvt_17_1_, lvt_18_1_, lvt_19_1_, this.spriteSet);
            }
        }
    }
}
