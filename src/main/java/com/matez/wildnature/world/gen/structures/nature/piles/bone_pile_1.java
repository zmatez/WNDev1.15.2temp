...
public class bone_pile_1 extends SchemFeature {
    public bone_pile_1() {
        super();
        terrainIncrease = 1;
    }
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(-1, 2, -2, "wildnature:pebble");
        Block(0, 2, -2, "minecraft:coarse_dirt");
        Block(1, 2, -2, "minecraft:bone_block[axis=y]");
        Block(1, 3, -2, "minecraft:bone_block[axis=y]");
        ...
        Block(-3, 1, 0, "minecraft:coarse_dirt");
        Block(-2, 1, 0, "minecraft:coarse_dirt");
        Block(-1, 1, 0, "minecraft:coarse_dirt");
        Block(0, 1, 0, "minecraft:coarse_dirt");
        Block(1, 1, 0, "minecraft:coarse_dirt");
        Block(2, 1, 0, "minecraft:stone");
        Block(-3, 2, 0, "minecraft:stone");
        Block(-2, 2, 0, "minecraft:bone_block[axis=y]");
        Block(-1, 2, 0, "minecraft:bone_block[axis=y]");
        Block(0, 2, 0, "minecraft:coarse_dirt");
        Block(1, 2, 0, "minecraft:stone");
        Block(-3, 3, 0, "wildnature:pebble");
        Block(-1, 3, 0, "minecraft:bone_block[axis=y]");
        Block(1, 3, 0, "wildnature:pebble");
        Block(-1, 4, 0, "wildnature:lightning_bug[facing=up]");
        ...
        Block(-3, 2, 1, "minecraft:bone_block[axis=x]");
        Block(-2, 2, 1, "minecraft:stone");
        Block(-1, 2, 1, "minecraft:coarse_dirt");
        Block(0, 2, 1, "minecraft:coarse_dirt");
        Block(1, 2, 1, "minecraft:stone");
        Block(2, 2, 1, "minecraft:coarse_dirt");
        Block(-3, 3, 1, "minecraft:bone_block[axis=y]");
        Block(0, 3, 1, "minecraft:stone");
        Block(-3, 1, 2, "minecraft:coarse_dirt");
        ...
        Block(-2, 3, 2, "wildnature:pebble");
        Block(-2, 1, 3, "minecraft:coarse_dirt");
