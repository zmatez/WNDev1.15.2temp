...
public class small_ebony3 extends SchemFeature {
    public small_ebony3() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(0, 4, -1, "wildnature:ebony_leaves[distance=1,persistent=true]");
        ...
        Block(-3, 5, -1, "wildnature:ebony_leaves[distance=2,persistent=true]");
        ...
        Block(-3, 4, 0, "wildnature:ebony_leaves[distance=2,persistent=true]");
        Block(-2, 4, 0, "wildnature:ebony_leaves[distance=1,persistent=true]");
        Block(-1, 4, 0, "wildnature:ebony_log[axis=x]");
        ...
        Block(-4, 5, 0, "wildnature:ebony_leaves[distance=2,persistent=true]");
        ...
        Block(-3, 7, 0, "wildnature:ebony_leaves[distance=1,persistent=true]");
