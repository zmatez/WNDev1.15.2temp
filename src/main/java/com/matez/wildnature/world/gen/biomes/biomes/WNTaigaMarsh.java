...
public class WNTaigaMarsh extends WNBiome {
    public WNTaigaMarsh(String name) {
        ...
        WNBiomeFeatures.addPlant(this, WNBlocks.PARROTS_FEATHER_PLANT.getDefaultState(), 8);
        ...
        WNBiomeFeatures.addTree(this, new thin_birch1(), 6);
        WNBiomeFeatures.addTree(this, new thin_birch2(), 6);
        WNBiomeFeatures.addTree(this, new thin_birch3(), 6);
        WNBiomeFeatures.addTree(this, new thin_birch4(), 6);
    ...
    public int getGrassColor(BlockPos pos) {
        ...
        return customColor(noise, -0.1D, 0x98C481, 0xADC47B);
    }
