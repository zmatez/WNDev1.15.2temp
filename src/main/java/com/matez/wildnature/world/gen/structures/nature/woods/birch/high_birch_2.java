...
public class high_birch_2 extends SchemFeature {
    public high_birch_2() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(0, 13, -2, "minecraft:birch_leaves[distance=1,persistent=true]");
        Block(0, 14, -2, "minecraft:birch_leaves[distance=2,persistent=true]");
        ...
        Block(0, 13, -1, "minecraft:birch_log[axis=z]");
        Block(1, 13, -1, "minecraft:birch_leaves[distance=1,persistent=true]");
        Block(-1, 14, -1, "minecraft:birch_leaves[distance=1,persistent=true]");
        Block(0, 14, -1, "minecraft:birch_leaves[distance=1,persistent=true]");
        Block(1, 14, -1, "minecraft:birch_leaves[distance=1,persistent=true]");
        Block(2, 14, -1, "minecraft:birch_leaves[distance=2,persistent=true]");
        ...
        Block(-1, 2, 0, "minecraft:birch_wood[axis=y]");
        ...
        Block(1, 13, 0, "minecraft:birch_leaves[distance=1,persistent=true]");
        Block(2, 13, 0, "minecraft:birch_leaves[distance=2,persistent=true]");
        Block(-2, 14, 0, "minecraft:birch_leaves[distance=1,persistent=true]");
        Block(-1, 14, 0, "minecraft:birch_log[axis=x]");
