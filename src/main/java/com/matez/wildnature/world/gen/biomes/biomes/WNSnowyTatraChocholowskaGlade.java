...
public class WNSnowyTatraChocholowskaGlade extends WNBiome {
    public WNSnowyTatraChocholowskaGlade(String name) {
        ...
        WNBiomeFeatures.addGrass(this, 4, WNBlocks.CROCUS_PURPLE.getDefaultState().with(FloweringBushBase.FLOWERING, false));
