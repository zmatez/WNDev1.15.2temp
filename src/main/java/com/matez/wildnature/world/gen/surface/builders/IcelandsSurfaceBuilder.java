...
public class IcelandsSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {
    ...
    private static final BlockState BROWN_TERRACOTTA = Blocks.BLUE_ICE.getDefaultState();
    private static final BlockState RED_TERRACOTTA = Blocks.WHITE_TERRACOTTA.getDefaultState();
    private static final BlockState LIGHT_GRAY_TERRACOTTA = Blocks.CYAN_TERRACOTTA.getDefaultState();
    ...
    public IcelandsSurfaceBuilder(Function<Dynamic<?>, ? extends SurfaceBuilderConfig> p_i51317_1_) {
        super(p_i51317_1_);
        setRegistryName("wildnature", "icelands_surface_builder");
    }
    ...
    public void setSeed(long seed) {
        ...
        if (this.field_215433_b != seed || this.field_215435_c == null || this.field_215437_d == null) {
            ...
            this.field_215435_c = new PerlinNoiseGenerator(random, 4,0);
            this.field_215437_d = new PerlinNoiseGenerator(random, 1,0);
        }
    ...
    protected void func_215430_b(long p_215430_1_) {
        ...
        this.field_215439_e = new PerlinNoiseGenerator(random, 1,0);
