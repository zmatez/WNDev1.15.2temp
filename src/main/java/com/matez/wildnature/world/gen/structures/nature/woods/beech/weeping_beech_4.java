...
public class weeping_beech_4 extends SchemFeature {
    public weeping_beech_4() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(-1, 8, 0, "wildnature:beech_branch[down=false,east=true,north=true,south=true,up=true,waterlogged=false,west=false]");
        Block(0, 8, 0, "wildnature:beech_branch[down=true,east=true,north=true,south=true,up=true,waterlogged=false,west=true]");
        ...
        Block(0, 10, 1, "wildnature:beech_leaves[distance=7,persistent=true]");
        Block(1, 10, 1, "wildnature:beech_leaves[distance=7,persistent=true]");
        Block(2, 6, 2, "wildnature:beech_leaves[distance=7,persistent=true]");
        Block(2, 7, 2, "wildnature:beech_leaves[distance=7,persistent=true]");
        Block(2, 8, 2, "wildnature:beech_leaves[distance=7,persistent=true]");
        Block(-2, 9, 2, "wildnature:beech_leaves[distance=7,persistent=true]");
        Block(-1, 9, 2, "wildnature:beech_leaves[distance=7,persistent=true]");
