...
public class spooky11 extends SchemFeature {
    public spooky11() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(1, 3, -4, "minecraft:dark_oak_leaves[distance=4,persistent=true]");
        Block(0, 4, -4, "minecraft:dark_oak_leaves[distance=3,persistent=true]");
        Block(1, 4, -4, "minecraft:dark_oak_leaves[distance=3,persistent=true]");
        Block(2, 4, -4, "minecraft:dark_oak_leaves[distance=3,persistent=true]");
        Block(1, 3, -3, "minecraft:cobweb");
        Block(3, 3, -3, "minecraft:dark_oak_leaves[distance=4,persistent=true]");
        Block(-2, 4, -3, "minecraft:dark_oak_leaves[distance=4,persistent=true]");
        Block(-1, 4, -3, "minecraft:dark_oak_leaves[distance=3,persistent=true]");
        Block(0, 4, -3, "minecraft:dark_oak_leaves[distance=2,persistent=true]");
        Block(1, 4, -3, "minecraft:dark_oak_leaves[distance=2,persistent=true]");
        Block(2, 4, -3, "minecraft:dark_oak_leaves[distance=2,persistent=true]");
        Block(3, 4, -3, "minecraft:dark_oak_leaves[distance=3,persistent=true]");
        Block(0, 5, -3, "minecraft:dark_oak_leaves[distance=1,persistent=true]");
        Block(0, 1, -2, "wildnature:lightning_bug[facing=north]");
        Block(1, 1, -2, "minecraft:dark_oak_log[axis=z]");
        Block(-1, 3, -2, "minecraft:dark_oak_leaves[distance=3,persistent=true]");
        Block(-2, 4, -2, "minecraft:dark_oak_leaves[distance=3,persistent=true]");
        Block(-1, 4, -2, "minecraft:dark_oak_leaves[distance=2,persistent=true]");
        Block(0, 4, -2, "minecraft:dark_oak_leaves[distance=1,persistent=true]");
        Block(1, 4, -2, "minecraft:dark_oak_leaves[distance=1,persistent=true]");
        Block(2, 4, -2, "minecraft:dark_oak_leaves[distance=1,persistent=true]");
        Block(3, 4, -2, "minecraft:dark_oak_leaves[distance=2,persistent=true]");
        Block(4, 4, -2, "minecraft:dark_oak_leaves[distance=3,persistent=true]");
        Block(-1, 5, -2, "minecraft:dark_oak_leaves[distance=1,persistent=true]");
        Block(0, 5, -2, "minecraft:dark_oak_log[axis=z]");
        Block(1, 5, -2, "minecraft:dark_oak_leaves[distance=1,persistent=true]");
        Block(0, 6, -2, "minecraft:dark_oak_leaves[distance=1,persistent=true]");
        ...
        Block(-2, 3, -1, "minecraft:dark_oak_leaves[distance=3,persistent=true]");
        Block(-1, 3, -1, "minecraft:cobweb");
        ...
        Block(-3, 4, -1, "minecraft:dark_oak_leaves[distance=3,persistent=true]");
        Block(-2, 4, -1, "minecraft:dark_oak_leaves[distance=2,persistent=true]");
        ...
        Block(2, 4, -1, "minecraft:dark_oak_log[axis=x]");
        Block(3, 4, -1, "minecraft:dark_oak_leaves[distance=1,persistent=true]");
        Block(4, 4, -1, "minecraft:dark_oak_leaves[distance=2,persistent=true]");
        ...
        Block(-1, 3, 0, "wildnature:lightning_bug[facing=west]");
        Block(0, 3, 0, "minecraft:dark_oak_log[axis=y]");
        Block(1, 3, 0, "minecraft:dark_oak_log[axis=y]");
        Block(2, 3, 0, "minecraft:cobweb");
        Block(-3, 4, 0, "minecraft:dark_oak_leaves[distance=3,persistent=true]");
        ...
        Block(2, 4, 0, "minecraft:dark_oak_leaves[distance=1,persistent=true]");
        Block(3, 4, 0, "minecraft:dark_oak_leaves[distance=2,persistent=true]");
        Block(4, 4, 0, "minecraft:dark_oak_leaves[distance=3,persistent=true]");
        ...
        Block(-3, 3, 1, "minecraft:dark_oak_leaves[distance=4,persistent=true]");
