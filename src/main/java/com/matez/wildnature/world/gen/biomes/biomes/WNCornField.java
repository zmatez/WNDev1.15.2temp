...
import com.matez.wildnature.world.gen.feature.features.CornGrassFeature;
...
public class WNCornField extends WNBiome {
    public WNCornField(String name) {
        ...
        this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, FeatureRegistry.CORN_GRASS_FEATURE.withConfiguration(new NoFeatureConfig()).withPlacement(Placement.COUNT_HEIGHTMAP_DOUBLE.configure(new FrequencyConfig(80))));
