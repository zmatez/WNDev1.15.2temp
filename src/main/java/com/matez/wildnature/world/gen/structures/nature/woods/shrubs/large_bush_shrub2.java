...
public class large_bush_shrub2 extends SchemFeature {
    public large_bush_shrub2() {
        super();
    }
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(0, 1, -3, "wildnature:large_bush_leaves[distance=7,persistent=true]");
        Block(0, 2, -3, "wildnature:large_bush_leaves[distance=7,persistent=true]");
        Block(1, 2, -3, "wildnature:large_bush_leaves[distance=7,persistent=true]");
        Block(0, 3, -3, "wildnature:large_bush_leaves[distance=7,persistent=true]");
        ...
        Block(0, 1, 1, "wildnature:large_bush_leaves[distance=7,persistent=true]");
        Block(0, 2, 1, "wildnature:large_bush_leaves[distance=7,persistent=true]");
