...
public class oaklands_shrub6 extends SchemFeature {
    public oaklands_shrub6() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(1, 3, -2, "minecraft:birch_leaves[distance=3,persistent=true]");
        Block(1, 1, -1, "minecraft:birch_leaves[distance=3,persistent=true]");
        Block(2, 1, -1, "minecraft:birch_leaves[distance=4,persistent=true]");
        ...
        Block(2, 1, 0, "minecraft:birch_leaves[distance=3,persistent=true]");
        ...
        Block(1, 2, 0, "minecraft:birch_leaves[distance=1,persistent=true]");
        Block(2, 2, 0, "minecraft:birch_leaves[distance=2,persistent=true]");
        Block(3, 2, 0, "minecraft:birch_leaves[distance=3,persistent=true]");
        ...
        Block(2, 1, 1, "minecraft:birch_leaves[distance=4,persistent=true]");
        Block(3, 1, 1, "minecraft:birch_leaves[distance=5,persistent=true]");
        Block(-2, 2, 1, "minecraft:birch_leaves[distance=3,persistent=true]");
        Block(-1, 2, 1, "minecraft:birch_leaves[distance=2,persistent=true]");
        Block(0, 2, 1, "minecraft:birch_leaves[distance=1,persistent=true]");
        Block(1, 2, 1, "minecraft:birch_leaves[distance=2,persistent=true]");
        ...
        Block(-2, 1, 2, "minecraft:birch_leaves[distance=4,persistent=true]");
        Block(1, 1, 2, "minecraft:birch_leaves[distance=4,persistent=true]");
        Block(2, 1, 2, "minecraft:birch_leaves[distance=5,persistent=true]");
        ...
        Block(1, 3, 2, "minecraft:birch_leaves[distance=3,persistent=true]");
        Block(1, 1, 3, "minecraft:birch_leaves[distance=5,persistent=true]");
