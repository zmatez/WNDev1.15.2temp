...
public class WNTemperateForest extends WNBiome {
    public WNTemperateForest(String name) {
        ...
        WNBiomeFeatures.addTree(this, new mega_oak_1(), 1);
        WNBiomeFeatures.addTree(this, new mega_oak_2(), 1);
        WNBiomeFeatures.addTree(this, new mega_oak_3(), 1);
        WNBiomeFeatures.addTree(this, new mega_oak_4(), 1);
        WNBiomeFeatures.addTree(this, new mega_oak_5(), 1);
        WNBiomeFeatures.addTree(this, new mega_oak_6(), 1);
        WNBiomeFeatures.addTree(this, new mega_oak_7(), 1);
        ...
        WNBiomeFeatures.addTree(this, new high_birch_1(), 1);
        WNBiomeFeatures.addTree(this, new high_birch_2(), 1);
        ...
        WNBiomeFeatures.addTree(this, new bald_high_oak_1(), 1);
        WNBiomeFeatures.addTree(this, new bald_high_oak_2(), 1);
        ...
        WNBiomeFeatures.addTreeVines(this, WNBlocks.ROSEVINE_WHITE.getDefaultState(), 1, 80);
