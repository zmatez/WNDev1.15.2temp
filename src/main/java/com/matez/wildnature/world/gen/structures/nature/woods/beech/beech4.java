...
public class beech4 extends SchemFeature {
    public beech4() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(0, 9, -1, "wildnature:beech_branch[down=false,east=true,north=false,south=true,up=true,waterlogged=false,west=false]");
        ...
        Block(0, 9, 0, "wildnature:beech_branch[down=true,east=true,north=true,south=false,up=true,waterlogged=false,west=false]");
        ...
        Block(-1, 10, 0, "wildnature:beech_branch[down=false,east=true,north=true,south=false,up=true,waterlogged=false,west=true]");
        Block(0, 10, 0, "wildnature:beech_branch[down=true,east=true,north=true,south=true,up=true,waterlogged=false,west=true]");
        Block(1, 10, 0, "wildnature:beech_branch[down=true,east=true,north=false,south=true,up=true,waterlogged=false,west=true]");
        Block(2, 10, 0, "wildnature:beech_leaves[distance=7,persistent=true]");
        ...
        Block(0, 12, 0, "wildnature:beech_leaves[distance=7,persistent=true]");
        Block(0, 10, 1, "wildnature:beech_leaves[distance=7,persistent=true]");
        Block(1, 10, 1, "wildnature:beech_leaves[distance=7,persistent=true]");
