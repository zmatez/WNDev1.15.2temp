...
public class oaklands_shrub1 extends SchemFeature {
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(1, 1, -2, "minecraft:oak_leaves[distance=4,persistent=true]");
        Block(2, 1, -2, "minecraft:oak_leaves[distance=5,persistent=true]");
        ...
        Block(-3, 1, -1, "minecraft:oak_leaves[distance=3,persistent=true]");
        ...
        Block(1, 3, -1, "minecraft:oak_leaves[distance=2,persistent=true]");
        Block(2, 3, -1, "minecraft:oak_leaves[distance=3,persistent=true]");
        Block(0, 4, -1, "minecraft:oak_leaves[distance=2,persistent=true]");
        ...
        Block(3, 1, 0, "minecraft:oak_leaves[distance=4,persistent=true]");
        ...
        Block(1, 3, 0, "minecraft:oak_leaves[distance=1,persistent=true]");
        Block(2, 3, 0, "minecraft:oak_leaves[distance=2,persistent=true]");
        Block(-2, 4, 0, "minecraft:oak_leaves[distance=3,persistent=true]");
        ...
        Block(-1, 1, 3, "minecraft:oak_leaves[distance=3,persistent=true]");
