...
public class beech5 extends SchemFeature {
    public beech5() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(0, 8, -1, "wildnature:beech_branch[down=true,east=false,north=false,south=true,up=true,waterlogged=false,west=true]");
        ...
        Block(0, 7, 0, "wildnature:beech_branch[down=true,east=false,north=true,south=false,up=true,waterlogged=false,west=false]");
        Block(0, 8, 0, "wildnature:beech_branch[down=true,east=true,north=true,south=true,up=true,waterlogged=false,west=false]");
        ...
        Block(0, 9, 0, "wildnature:beech_branch[down=true,east=true,north=true,south=false,up=false,waterlogged=false,west=true]");
        Block(1, 9, 0, "wildnature:beech_branch[down=true,east=true,north=true,south=false,up=true,waterlogged=false,west=true]");
        Block(2, 9, 0, "wildnature:beech_leaves[distance=7,persistent=true]");
