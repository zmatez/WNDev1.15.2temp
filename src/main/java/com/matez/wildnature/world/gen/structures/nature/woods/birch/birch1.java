...
public class birch1 extends SchemFeature {
    public birch1() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(-1, 6, -2, "minecraft:birch_leaves[distance=2,persistent=true]");
        Block(0, 6, -2, "minecraft:birch_leaves[distance=1,persistent=true]");
        Block(1, 6, -2, "minecraft:birch_leaves[distance=2,persistent=true]");
        Block(2, 6, -2, "minecraft:birch_leaves[distance=2,persistent=true]");
        ...
        Block(-1, 6, -1, "minecraft:birch_leaves[distance=1,persistent=true]");
        Block(0, 6, -1, "minecraft:birch_log[axis=y]");
        Block(1, 6, -1, "minecraft:birch_leaves[distance=1,persistent=true]");
        Block(2, 6, -1, "minecraft:birch_leaves[distance=1,persistent=true]");
        Block(-1, 7, -1, "minecraft:birch_leaves[distance=1,persistent=true]");
        Block(0, 7, -1, "minecraft:birch_log[axis=y]");
        Block(1, 7, -1, "minecraft:birch_leaves[distance=1,persistent=true]");
        Block(2, 7, -1, "minecraft:birch_leaves[distance=2,persistent=true]");
        ...
        Block(1, 5, 0, "minecraft:birch_log[axis=x]");
        Block(2, 5, 0, "minecraft:birch_leaves[distance=1,persistent=true]");
        Block(-1, 6, 0, "minecraft:birch_leaves[distance=1,persistent=true]");
        Block(0, 6, 0, "minecraft:birch_log[axis=y]");
        Block(1, 6, 0, "minecraft:birch_leaves[distance=1,persistent=true]");
        Block(2, 6, 0, "minecraft:birch_log[axis=y]");
        Block(3, 6, 0, "minecraft:birch_leaves[distance=1,persistent=true]");
        ...
        Block(0, 8, 0, "minecraft:birch_leaves[distance=2,persistent=true]");
        Block(1, 8, 0, "minecraft:birch_leaves[distance=3,persistent=true]");
        ...
        Block(1, 7, 1, "minecraft:birch_leaves[distance=3,persistent=true]");
