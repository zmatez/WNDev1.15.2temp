...
public class cypress4 extends SchemFeature {
    public cypress4() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(0, 12, -2, "minecraft:spruce_leaves[distance=2,persistent=true]");
        Block(0, 13, -2, "minecraft:spruce_leaves[distance=2,persistent=true]");
        ...
        Block(1, 13, -1, "minecraft:spruce_leaves[distance=2,persistent=true]");
        Block(-1, 14, -1, "minecraft:spruce_leaves[distance=2,persistent=true]");
        Block(0, 14, -1, "minecraft:spruce_leaves[distance=1,persistent=true]");
        Block(1, 14, -1, "minecraft:spruce_leaves[distance=2,persistent=true]");
        Block(0, 15, -1, "minecraft:spruce_leaves[distance=1,persistent=true]");
        Block(0, 16, -1, "minecraft:spruce_leaves[distance=1,persistent=true]");
        ...
        Block(1, 11, 0, "minecraft:spruce_leaves[distance=1,persistent=true]");
        Block(2, 11, 0, "minecraft:spruce_leaves[distance=2,persistent=true]");
        Block(-2, 12, 0, "minecraft:spruce_leaves[distance=2,persistent=true]");
        ...
        Block(1, 13, 0, "minecraft:spruce_leaves[distance=1,persistent=true]");
        Block(2, 13, 0, "minecraft:spruce_leaves[distance=2,persistent=true]");
        Block(-1, 14, 0, "minecraft:spruce_leaves[distance=1,persistent=true]");
        Block(0, 14, 0, "wildnature:redwood_log[axis=y]");
        Block(1, 14, 0, "minecraft:spruce_leaves[distance=1,persistent=true]");
        Block(2, 14, 0, "minecraft:spruce_leaves[distance=2,persistent=true]");
        Block(-1, 15, 0, "minecraft:spruce_leaves[distance=1,persistent=true]");
        Block(0, 15, 0, "wildnature:redwood_log[axis=y]");
        Block(1, 15, 0, "minecraft:spruce_leaves[distance=1,persistent=true]");
        Block(-1, 16, 0, "minecraft:spruce_leaves[distance=1,persistent=true]");
        Block(0, 16, 0, "wildnature:redwood_log[axis=y]");
        Block(1, 16, 0, "minecraft:spruce_leaves[distance=1,persistent=true]");
        Block(0, 17, 0, "minecraft:spruce_leaves[distance=1,persistent=true]");
        Block(0, 18, 0, "minecraft:spruce_leaves[distance=2,persistent=true]");
        Block(0, 3, 1, "minecraft:spruce_leaves[distance=1,persistent=true]");
        ...
        Block(0, 12, 2, "minecraft:spruce_leaves[distance=2,persistent=true]");
        Block(0, 13, 2, "minecraft:spruce_leaves[distance=2,persistent=true]");
        Block(0, 14, 2, "minecraft:spruce_leaves[distance=2,persistent=true]");
