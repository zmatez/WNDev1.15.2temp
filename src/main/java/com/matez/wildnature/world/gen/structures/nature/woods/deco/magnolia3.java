...
public class magnolia3 extends SchemFeature {
    public magnolia3() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(0, 4, -2, "wildnature:rosaceae_branch[down=false,east=false,north=false,south=true,up=true,waterlogged=false,west=false]");
        ...
        Block(4, 3, -1, "wildnature:magnolia_leaves[distance=7,flowering=false,persistent=true]");
        Block(0, 4, -1, "wildnature:rosaceae_branch[down=false,east=false,north=true,south=true,up=false,waterlogged=false,west=false]");
        Block(3, 4, -1, "wildnature:magnolia_leaves[distance=6,flowering=false,persistent=true]");
        ...
        Block(-2, 4, 0, "wildnature:rosaceae_branch[down=false,east=true,north=false,south=false,up=true,waterlogged=false,west=false]");
        ...
        Block(1, 4, 0, "wildnature:rosaceae_branch[down=false,east=false,north=false,south=false,up=true,waterlogged=false,west=true]");
        Block(-3, 5, 0, "wildnature:magnolia_leaves[distance=6,flowering=false,persistent=true]");
        Block(-2, 5, 0, "wildnature:rosaceae_branch[down=true,east=false,north=true,south=true,up=true,waterlogged=false,west=true]");
