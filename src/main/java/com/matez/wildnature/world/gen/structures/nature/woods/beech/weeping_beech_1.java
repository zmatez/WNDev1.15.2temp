...
public class weeping_beech_1 extends SchemFeature {
    public weeping_beech_1() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(1, 8, 0, "wildnature:beech_branch[down=false,east=true,north=true,south=true,up=true,waterlogged=false,west=true]");
        ...
        Block(-2, 9, 1, "wildnature:beech_leaves[distance=7,persistent=true]");
        Block(-1, 9, 1, "wildnature:beech_leaves[distance=7,persistent=true]");
        Block(0, 9, 1, "wildnature:beech_branch[down=true,east=true,north=true,south=true,up=true,waterlogged=false,west=true]");
        Block(1, 9, 1, "wildnature:beech_leaves[distance=7,persistent=true]");
        Block(2, 9, 1, "wildnature:beech_leaves[distance=7,persistent=true]");
        Block(3, 9, 1, "wildnature:beech_leaves[distance=7,persistent=true]");
        ...
        Block(1, 9, 2, "wildnature:beech_leaves[distance=7,persistent=true]");
        Block(2, 9, 2, "wildnature:beech_leaves[distance=7,persistent=true]");
        Block(-2, 10, 2, "wildnature:beech_leaves[distance=7,persistent=true]");
        Block(-1, 10, 2, "wildnature:beech_leaves[distance=7,persistent=true]");
        Block(-1, 7, 3, "wildnature:beech_leaves[distance=7,persistent=true]");
        Block(1, 7, 3, "wildnature:beech_leaves[distance=7,persistent=true]");
        Block(-2, 8, 3, "wildnature:beech_leaves[distance=7,persistent=true]");
        Block(-1, 8, 3, "wildnature:beech_leaves[distance=7,persistent=true]");
        Block(1, 8, 3, "wildnature:beech_leaves[distance=7,persistent=true]");
