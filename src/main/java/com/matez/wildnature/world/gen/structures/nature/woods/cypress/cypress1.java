...
public class cypress1 extends SchemFeature {
    public cypress1() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(1, 14, 0, "minecraft:spruce_leaves[distance=1,persistent=true]");
        Block(0, 15, 0, "minecraft:spruce_leaves[distance=1,persistent=true]");
        Block(0, 16, 0, "minecraft:spruce_leaves[distance=2,persistent=true]");
        Block(0, 3, 1, "minecraft:spruce_leaves[distance=1,persistent=true]");
        Block(0, 4, 1, "minecraft:spruce_leaves[distance=1,persistent=true]");
        Block(-1, 5, 1, "minecraft:spruce_leaves[distance=2,persistent=true]");
        Block(0, 5, 1, "minecraft:spruce_leaves[distance=1,persistent=true]");
