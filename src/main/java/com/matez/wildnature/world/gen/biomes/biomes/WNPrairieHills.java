...
public class WNPrairieHills extends WNBiome {
    public WNPrairieHills(String name) {
        ...
        WNBiomeFeatures.addGrass(this, 25, WNBlocks.PRAIRIE_GRASS.getDefaultState().with(FloweringBushBase.FLOWERING, true));
