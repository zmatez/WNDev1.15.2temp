...
public class glowing_cave_oak_3 extends SchemFeature {
    public glowing_cave_oak_3() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(1, 11, -3, LEAVES);
        Block(2, 11, -3, LEAVES);
        Block(1, 9, -2, "wildnature:glowing_cave_oak_log[axis=x]");
        Block(2, 9, -2, LEAVES);
        Block(-3, 10, -2, LEAVES);
        Block(-2, 10, -2, LEAVES);
        Block(-1, 10, -2, LEAVES);
        Block(0, 10, -2, LEAVES);
        Block(1, 10, -2, LEAVES);
        Block(2, 10, -2, "wildnature:glowing_cave_oak_log[axis=x]");
        Block(3, 10, -2, LEAVES);
        Block(-2, 11, -2, LEAVES);
        Block(-1, 11, -2, LEAVES);
        Block(0, 11, -2, LEAVES);
        ...
        Block(1, 8, 0, LEAVES);
        Block(-3, 9, 0, LEAVES);
        Block(-2, 9, 0, "wildnature:glowing_cave_oak_log[axis=x]");
        Block(-1, 9, 0, "wildnature:glowing_cave_oak_log[axis=x]");
        Block(0, 9, 0, "wildnature:glowing_cave_oak_log[axis=y]");
        Block(1, 9, 0, LEAVES);
        Block(-4, 10, 0, LEAVES);
        Block(-3, 10, 0, "wildnature:glowing_cave_oak_log[axis=x]");
        Block(-2, 10, 0, LEAVES);
        Block(-1, 10, 0, LEAVES);
        ...
        Block(0, 8, 1, "wildnature:glowing_cave_oak_log[axis=z]");
        Block(-1, 9, 1, LEAVES);
        Block(0, 9, 1, LEAVES);
        Block(-3, 10, 1, LEAVES);
        Block(-2, 10, 1, LEAVES);
        ...
        Block(1, 12, 1, LEAVES);
        Block(-2, 8, 2, LEAVES);
        Block(0, 8, 2, "wildnature:glowing_cave_oak_log[axis=z]");
        Block(2, 8, 2, LEAVES);
        Block(-2, 9, 2, LEAVES);
        Block(0, 9, 2, LEAVES);
        Block(2, 9, 2, LEAVES);
        ...
        Block(0, 11, 2, LEAVES);
        Block(1, 11, 2, LEAVES);
        Block(0, 9, 3, "wildnature:glowing_cave_oak_log[axis=z]");
        Block(-2, 10, 3, LEAVES);
        Block(-1, 10, 3, LEAVES);
        Block(0, 10, 3, LEAVES);
        Block(1, 10, 3, LEAVES);
