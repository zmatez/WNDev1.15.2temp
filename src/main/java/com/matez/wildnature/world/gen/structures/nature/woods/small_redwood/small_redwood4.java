...
public class small_redwood4 extends SchemFeature {
    public small_redwood4() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(1, 11, -2, "wildnature:redwood_leaves[distance=3,persistent=true]");
        ...
        Block(0, 8, -1, "wildnature:redwood_leaves[distance=1,persistent=true]");
        Block(1, 8, -1, "wildnature:redwood_leaves[distance=2,persistent=true]");
        Block(-2, 10, -1, "wildnature:redwood_leaves[distance=3,persistent=true]");
        Block(-3, 11, -1, "wildnature:redwood_leaves[distance=3,persistent=true]");
        ...
        Block(0, 12, -1, "wildnature:redwood_branch[down=true,east=true,north=true,south=true,up=true,waterlogged=false,west=true]");
        Block(1, 12, -1, "wildnature:redwood_leaves[distance=2,persistent=true]");
        ...
        Block(1, 7, 0, "wildnature:redwood_leaves[distance=1,persistent=true]");
        Block(-1, 8, 0, "wildnature:redwood_leaves[distance=1,persistent=true]");
        Block(0, 8, 0, "wildnature:redwood_log[axis=y]");
        Block(1, 8, 0, "wildnature:redwood_branch[down=true,east=true,north=true,south=true,up=true,waterlogged=false,west=true]");
        Block(2, 8, 0, "wildnature:redwood_leaves[distance=7,persistent=true]");
        Block(0, 9, 0, "wildnature:redwood_log[axis=y]");
        Block(1, 9, 0, "wildnature:redwood_leaves[distance=1,persistent=true]");
        Block(-2, 10, 0, "wildnature:redwood_leaves[distance=2,persistent=true]");
        Block(-1, 10, 0, "wildnature:redwood_leaves[distance=1,persistent=true]");
        Block(0, 10, 0, "wildnature:redwood_log[axis=y]");
        Block(1, 10, 0, "wildnature:redwood_leaves[distance=1,persistent=true]");
        Block(-3, 11, 0, "wildnature:redwood_leaves[distance=4,persistent=true]");
        Block(-2, 11, 0, "wildnature:redwood_branch[down=true,east=true,north=true,south=true,up=true,waterlogged=false,west=true]");
        Block(-1, 11, 0, "wildnature:redwood_log[axis=x]");
        ...
        Block(-2, 10, 1, "wildnature:redwood_leaves[distance=3,persistent=true]");
        Block(-1, 10, 1, "wildnature:redwood_leaves[distance=2,persistent=true]");
        Block(0, 10, 1, "wildnature:redwood_branch[down=true,east=true,north=true,south=true,up=true,waterlogged=false,west=true]");
        Block(1, 10, 1, "wildnature:redwood_leaves[distance=2,persistent=true]");
        Block(-2, 11, 1, "wildnature:redwood_leaves[distance=2,persistent=true]");
        Block(-1, 11, 1, "wildnature:redwood_leaves[distance=1,persistent=true]");
        Block(0, 11, 1, "wildnature:redwood_leaves[distance=1,persistent=true]");
        ...
        Block(0, 13, 1, "wildnature:redwood_leaves[distance=1,persistent=true]");
        Block(0, 14, 1, "wildnature:redwood_leaves[distance=2,persistent=true]");
        Block(0, 10, 2, "wildnature:redwood_leaves[distance=3,persistent=true]");
        Block(-2, 11, 2, "wildnature:redwood_leaves[distance=3,persistent=true]");
        Block(-1, 11, 2, "wildnature:redwood_leaves[distance=2,persistent=true]");
        Block(0, 11, 2, "wildnature:redwood_leaves[distance=2,persistent=true]");
        Block(1, 11, 2, "wildnature:redwood_leaves[distance=3,persistent=true]");
