...
public class big_birch_2 extends SchemFeature {
    public big_birch_2() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(-1, 4, 1, "minecraft:birch_leaves[distance=3,persistent=true]");
        Block(-2, 5, 1, "minecraft:birch_leaves[distance=3,persistent=true]");
        Block(-1, 5, 1, "minecraft:birch_leaves[distance=2,persistent=true]");
        Block(0, 5, 1, "minecraft:birch_leaves[distance=1,persistent=true]");
        Block(1, 5, 1, "minecraft:birch_leaves[distance=2,persistent=true]");
        ...
        Block(1, 5, 2, "minecraft:birch_leaves[distance=3,persistent=true]");
        Block(2, 5, 2, "minecraft:birch_leaves[distance=4,persistent=true]");
        Block(-4, 7, 2, "minecraft:birch_leaves[distance=6,persistent=true]");
        ...
        Block(-3, 7, 3, "minecraft:birch_leaves[distance=6,persistent=true]");
        ...
        Block(0, 9, 3, "minecraft:birch_leaves[distance=3,persistent=true]");
        Block(-2, 11, 3, "minecraft:birch_leaves[distance=5,persistent=true]");
        Block(-1, 11, 3, "minecraft:birch_leaves[distance=4,persistent=true]");
