...
public class spooky7 extends SchemFeature {
    public spooky7() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(-1, 3, -1, "minecraft:dark_oak_log[axis=z]");
        ...
        Block(1, 2, 1, "wildnature:lightning_bug[facing=up]");
        ...
        Block(0, 7, 1, "minecraft:cobweb");
        Block(0, 1, 2, "minecraft:dark_oak_log[axis=y]");
        Block(0, 2, 2, "minecraft:dark_oak_log[axis=y]");
        Block(0, 3, 2, "wildnature:lightning_bug[facing=up]");
        Block(0, 4, 2, "minecraft:cobweb");
        ...
        Block(0, 6, 3, "minecraft:dark_oak_leaves[distance=3,persistent=true]");
