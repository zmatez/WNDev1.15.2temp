...
public class WNBorealValley extends WNBiome {
    public WNBorealValley(String name) {
        ...
        this.addSpawn(EntityClassification.CREATURE, new SpawnListEntry(EntityType.COW, 12, 4, 4));
