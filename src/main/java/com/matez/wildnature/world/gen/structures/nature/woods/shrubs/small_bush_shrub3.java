...
public class small_bush_shrub3 extends SchemFeature {
    public small_bush_shrub3() {
        super();
    }
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(1, 1, -1, "wildnature:small_bush_leaves[distance=7,persistent=true]");
        Block(-1, 1, 0, "wildnature:small_bush_leaves[distance=7,persistent=true]");
        Block(0, 1, 0, "wildnature:small_bush_leaves[distance=7,persistent=true]");
        Block(1, 1, 0, "wildnature:small_bush_leaves[distance=7,persistent=true]");
        Block(-1, 2, 0, "wildnature:small_bush_leaves[distance=7,persistent=true]");
        Block(0, 2, 0, "wildnature:small_bush_leaves[distance=7,persistent=true]");
        Block(1, 2, 0, "wildnature:small_bush_leaves[distance=7,persistent=true]");
        Block(2, 2, 0, "wildnature:small_bush_leaves[distance=7,persistent=true]");
        Block(0, 3, 0, "wildnature:small_bush_leaves[distance=7,persistent=true]");
        Block(-1, 1, 1, "wildnature:small_bush_leaves[distance=7,persistent=true]");
        ...
        Block(1, 2, 1, "wildnature:small_bush_leaves[distance=7,persistent=true]");
        Block(2, 2, 1, "wildnature:small_bush_leaves[distance=7,persistent=true]");
