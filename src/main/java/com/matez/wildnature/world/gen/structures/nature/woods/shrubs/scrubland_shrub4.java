...
public class scrubland_shrub4 extends SchemFeature {
    public scrubland_shrub4() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(1, 1, -1, "minecraft:oak_leaves[distance=2,persistent=true]");
        Block(-2, 2, -1, "minecraft:oak_leaves[distance=4,persistent=true]");
        ...
        Block(2, 2, 0, "minecraft:oak_leaves[distance=5,persistent=true]");
        ...
        Block(-1, 2, 2, "minecraft:oak_leaves[distance=4,persistent=true]");
