...
public class WNOreFeatureConfig implements IFeatureConfig {
   public final WNOreFeatureConfig.FillerBlockType target;
   public final int size;
   public final BlockState state;

   public WNOreFeatureConfig(WNOreFeatureConfig.FillerBlockType target, BlockState state, int size) {
      this.size = size;
      this.state = state;
      this.target = target;
   }
   ...
   public static WNOreFeatureConfig deserialize(Dynamic<?> p_214641_0_) {
      int i = p_214641_0_.get("size").asInt(0);
      WNOreFeatureConfig.FillerBlockType orefeatureconfig$fillerblocktype = WNOreFeatureConfig.FillerBlockType.func_214736_a(p_214641_0_.get("target").asString(""));
      BlockState blockstate = p_214641_0_.get("state").map(BlockState::deserialize).orElse(Blocks.AIR.getDefaultState());
      return new WNOreFeatureConfig(orefeatureconfig$fillerblocktype, blockstate, i);
   }
   ...
   public static enum FillerBlockType implements net.minecraftforge.common.IExtensibleEnum {
      ...
      private static final Map<String, WNOreFeatureConfig.FillerBlockType> field_214741_c = Arrays.stream(values()).collect(Collectors.toMap(WNOreFeatureConfig.FillerBlockType::func_214737_a, (p_214740_0_) -> {
         return p_214740_0_;
      }));
      ...
      public static WNOreFeatureConfig.FillerBlockType func_214736_a(String p_214736_0_) {
