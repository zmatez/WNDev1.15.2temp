...
public class spooky12 extends SchemFeature {
    public spooky12() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(2, 3, -1, "wildnature:lightning_bug[facing=down]");
        ...
        Block(1, 7, -1, "minecraft:dark_oak_leaves[distance=2,persistent=true]");
        ...
        Block(-1, 2, 0, "wildnature:lightning_bug[facing=west]");
