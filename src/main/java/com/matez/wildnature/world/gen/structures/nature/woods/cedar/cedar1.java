...
public class cedar1 extends SchemFeature {
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(0, 4, -3, "wildnature:cedar_leaves[distance=7,persistent=true]");
        Block(-1, 2, -2, "wildnature:cedar_leaves[distance=3,persistent=true]");
        ...
        Block(-1, 4, -2, "wildnature:cedar_leaves[distance=3,persistent=true]");
        Block(0, 4, -2, "wildnature:cedar_branch[down=true,east=true,north=true,south=true,up=true,waterlogged=false,west=true]");
        Block(1, 4, -2, "wildnature:cedar_leaves[distance=7,persistent=true]");
        ...
        Block(-2, 3, 0, "wildnature:cedar_branch[down=true,east=true,north=true,south=true,up=true,waterlogged=false,west=true]");
        ...
        Block(-1, 6, 0, "wildnature:cedar_branch[down=false,east=true,north=true,south=true,up=true,waterlogged=false,west=true]");
        ...
        Block(1, 8, 0, "wildnature:cedar_leaves[distance=2,persistent=true]");
        Block(-1, 9, 0, "wildnature:cedar_leaves[distance=3,persistent=true]");
        Block(0, 9, 0, "wildnature:cedar_branch[down=true,east=true,north=true,south=true,up=true,waterlogged=false,west=true]");
        Block(1, 9, 0, "wildnature:cedar_leaves[distance=3,persistent=true]");
        Block(0, 10, 0, "wildnature:cedar_leaves[distance=7,persistent=true]");
        ...
        Block(0, 7, 1, "wildnature:cedar_branch[down=true,east=true,north=true,south=true,up=true,waterlogged=false,west=true]");
        Block(1, 7, 1, "wildnature:cedar_leaves[distance=2,persistent=true]");
        Block(0, 8, 1, "wildnature:cedar_leaves[distance=7,persistent=true]");
        Block(0, 9, 1, "wildnature:cedar_leaves[distance=7,persistent=true]");
        Block(-1, 2, 2, "wildnature:cedar_leaves[distance=3,persistent=true]");
        Block(0, 2, 2, "wildnature:cedar_leaves[distance=4,persistent=true]");
        Block(0, 4, 2, "wildnature:cedar_leaves[distance=7,persistent=true]");
        Block(0, 7, 2, "wildnature:cedar_leaves[distance=7,persistent=true]");
        Block(0, 2, 3, "wildnature:cedar_leaves[distance=5,persistent=true]");
