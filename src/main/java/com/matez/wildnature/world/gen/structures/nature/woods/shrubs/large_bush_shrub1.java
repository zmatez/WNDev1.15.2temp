...
public class large_bush_shrub1 extends SchemFeature {
    public large_bush_shrub1() {
        super();
    }
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(-2, 2, 0, "wildnature:large_bush_leaves[distance=7,persistent=true]");
        ...
        Block(-2, 2, 1, "wildnature:large_bush_leaves[distance=7,persistent=true]");
        Block(-1, 2, 1, "wildnature:large_bush_leaves[distance=7,persistent=true]");
        ...
        Block(0, 3, 1, "wildnature:large_bush_leaves[distance=7,persistent=true]");
