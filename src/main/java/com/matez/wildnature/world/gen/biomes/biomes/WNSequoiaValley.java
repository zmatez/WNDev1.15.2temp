...
public class WNSequoiaValley extends WNBiome {
    public WNSequoiaValley(String name) {
        ...
        WNBiomeFeatures.addGrass(this, 12, WNBlocks.MOSS.getDefaultState());
        WNBiomeFeatures.addGrass(this, 10, Blocks.LARGE_FERN.getDefaultState(), true);
