...
public class oaklands_oak7 extends SchemFeature {
    public oaklands_oak7() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(0, 10, -3, "minecraft:oak_leaves[distance=3,persistent=true]");
        ...
        Block(0, 11, -2, "minecraft:oak_leaves[distance=3,persistent=true]");
        ...
        Block(1, 9, -1, "minecraft:oak_log[axis=z]");
        ...
        Block(3, 9, 0, "minecraft:oak_leaves[distance=1,persistent=true]");
        ...
        Block(2, 10, 0, "minecraft:oak_leaves[distance=1,persistent=true]");
        Block(3, 10, 0, "minecraft:oak_leaves[distance=2,persistent=true]");
        Block(4, 10, 0, "minecraft:oak_leaves[distance=3,persistent=true]");
        ...
        Block(1, 11, 0, "minecraft:oak_leaves[distance=1,persistent=true]");
        Block(2, 11, 0, "minecraft:oak_leaves[distance=2,persistent=true]");
        Block(3, 11, 0, "minecraft:oak_leaves[distance=3,persistent=true]");
        ...
        Block(4, 1, 1, "minecraft:oak_log[axis=x]");
        ...
        Block(2, 9, 1, "minecraft:oak_leaves[distance=1,persistent=true]");
        Block(3, 9, 1, "minecraft:oak_leaves[distance=2,persistent=true]");
        Block(-3, 10, 1, "minecraft:oak_leaves[distance=3,persistent=true]");
        Block(-2, 10, 1, "minecraft:oak_leaves[distance=2,persistent=true]");
        Block(-1, 10, 1, "minecraft:oak_leaves[distance=1,persistent=true]");
        ...
        Block(4, 10, 1, "minecraft:oak_leaves[distance=3,persistent=true]");
        Block(-2, 11, 1, "minecraft:oak_leaves[distance=3,persistent=true]");
        Block(-1, 11, 1, "minecraft:oak_leaves[distance=2,persistent=true]");
        ...
        Block(1, 13, 1, "minecraft:oak_leaves[distance=3,persistent=true]");
        ...
        Block(2, 11, 2, "minecraft:oak_leaves[distance=3,persistent=true]");
        ...
        Block(2, 10, 3, "minecraft:oak_leaves[distance=3,persistent=true]");
