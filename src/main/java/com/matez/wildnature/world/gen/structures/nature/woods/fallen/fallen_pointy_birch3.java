...
public class fallen_pointy_birch3 extends SchemFeature {
    public fallen_pointy_birch3() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(2, 1, -2, "minecraft:birch_leaves[distance=7,persistent=true]");
        Block(1, 1, -1, "minecraft:birch_leaves[distance=1,persistent=true]");
        Block(3, 1, -1, "minecraft:birch_log[axis=z]");
        Block(3, 2, -1, "minecraft:birch_leaves[distance=1,persistent=true]");
        Block(-4, 1, 0, "minecraft:birch_log[axis=x]");
