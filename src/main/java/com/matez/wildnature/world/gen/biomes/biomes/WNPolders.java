...
public class WNPolders extends WNBiome {
    public WNPolders(String name) {
        super(name, (new WNBiomeBuilder())
                .surfaceBuilder(new PolderSurfaceBuilder(SurfaceBuilderConfig::deserialize), SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG)
