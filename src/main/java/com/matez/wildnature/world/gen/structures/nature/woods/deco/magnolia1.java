...
public class magnolia1 extends SchemFeature {
    public magnolia1() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(-1, 4, -3, "wildnature:magnolia_leaves[distance=7,flowering=false,persistent=true]");
        Block(4, 4, -3, "wildnature:magnolia_leaves[distance=7,flowering=false,persistent=true]");
        Block(0, 5, -3, "wildnature:magnolia_leaves[distance=4,flowering=false,persistent=true]");
        ...
        Block(0, 5, -2, "wildnature:magnolia_leaves[distance=3,flowering=false,persistent=true]");
        Block(1, 5, -2, "wildnature:magnolia_leaves[distance=4,flowering=false,persistent=true]");
        Block(2, 5, -2, "wildnature:magnolia_leaves[distance=5,flowering=false,persistent=true]");
        Block(3, 5, -2, "wildnature:magnolia_leaves[distance=6,flowering=false,persistent=true]");
        ...
        Block(-1, 4, 0, "wildnature:rosaceae_branch[down=false,east=true,north=false,south=false,up=true,waterlogged=false,west=false]");
        Block(0, 4, 0, "wildnature:rosaceae_log[axis=y]");
        Block(4, 4, 0, "wildnature:magnolia_leaves[distance=7,flowering=false,persistent=true]");
        ...
        Block(-1, 5, 0, "wildnature:rosaceae_branch[down=true,east=true,north=false,south=false,up=true,waterlogged=false,west=true]");
        ...
        Block(0, 5, 3, "wildnature:magnolia_leaves[distance=4,flowering=false,persistent=true]");
        Block(2, 5, 3, "wildnature:magnolia_leaves[distance=6,flowering=false,persistent=true]");
        Block(3, 5, 3, "wildnature:magnolia_leaves[distance=7,flowering=false,persistent=true]");
        Block(0, 5, 4, "wildnature:magnolia_leaves[distance=5,flowering=false,persistent=true]");
        Block(1, 5, 4, "wildnature:magnolia_leaves[distance=6,flowering=false,persistent=true]");
        Block(1, 3, 5, "wildnature:magnolia_leaves[distance=7,flowering=false,persistent=true]");
        Block(0, 4, 5, "wildnature:magnolia_leaves[distance=7,flowering=false,persistent=true]");
        Block(1, 4, 5, "wildnature:magnolia_leaves[distance=7,flowering=false,persistent=true]");
