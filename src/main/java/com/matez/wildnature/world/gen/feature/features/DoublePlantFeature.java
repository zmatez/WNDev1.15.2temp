...
public class DoublePlantFeature extends Feature<BlockFeatureConfig> {
   public DoublePlantFeature(Function<Dynamic<?>, ? extends BlockFeatureConfig> p_i49884_1_) {
      super(p_i49884_1_);
      setRegistryName("wildnature","double_plant_feature");
   }
