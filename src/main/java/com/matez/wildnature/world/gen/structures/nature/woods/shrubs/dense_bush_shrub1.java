...
public class dense_bush_shrub1 extends SchemFeature {
    public dense_bush_shrub1() {
        super();
    }
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(-3, 1, 1, "wildnature:dense_bush_leaves[distance=7,persistent=true]");
        ...
        Block(1, 1, 1, "wildnature:dense_bush_leaves[distance=7,persistent=true]");
        Block(-2, 2, 1, "wildnature:dense_bush_leaves[distance=7,persistent=true]");
        Block(0, 2, 1, "wildnature:dense_bush_leaves[distance=7,persistent=true]");
        ...
        Block(0, 1, 3, "wildnature:dense_bush_leaves[distance=7,persistent=true]");
