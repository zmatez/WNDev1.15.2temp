...
public class spooky2 extends SchemFeature {
    public spooky2() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(1, 2, 0, "wildnature:lightning_bug[facing=east]");
        ...
        Block(1, 3, 1, "minecraft:dark_oak_leaves[distance=1,persistent=true]");
        Block(-4, 4, 1, "minecraft:dark_oak_leaves[distance=3,persistent=true]");
        ...
        Block(-4, 4, 2, "minecraft:dark_oak_leaves[distance=4,persistent=true]");
        Block(-3, 4, 2, "minecraft:dark_oak_leaves[distance=3,persistent=true]");
        ...
        Block(-3, 4, 3, "minecraft:dark_oak_leaves[distance=4,persistent=true]");
        Block(-2, 4, 3, "minecraft:dark_oak_leaves[distance=3,persistent=true]");
