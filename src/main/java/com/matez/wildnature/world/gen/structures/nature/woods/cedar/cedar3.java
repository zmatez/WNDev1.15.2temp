...
public class cedar3 extends SchemFeature {
    public cedar3() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(-1, 7, 0, "wildnature:cedar_leaves[distance=7,persistent=true]");
        ...
        Block(-3, 2, 1, "wildnature:cedar_leaves[distance=7,persistent=true]");
        ...
        Block(2, 2, 1, "wildnature:cedar_leaves[distance=7,persistent=true]");
        Block(0, 3, 1, "wildnature:cedar_leaves[distance=1,persistent=true]");
        Block(-2, 4, 1, "wildnature:cedar_leaves[distance=7,persistent=true]");
