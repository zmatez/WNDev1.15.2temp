...
public class WNCottonFields extends WNBiome {
    public WNCottonFields(String name) {
        ...
        WNBiomeFeatures.addGrass(this, 20, WNBlocks.COTTON_PLANT.getDefaultState().with(Age2Plant.AGE, 1));
