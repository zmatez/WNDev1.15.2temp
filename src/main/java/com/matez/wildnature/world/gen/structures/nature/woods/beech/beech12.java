...
public class beech12 extends SchemFeature {
    public beech12() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(0, 12, -1, "wildnature:beech_branch[down=true,east=true,north=true,south=true,up=true,waterlogged=false,west=true]");
        Block(1, 12, -1, "wildnature:beech_leaves[distance=7,persistent=true]");
        ...
        Block(-1, 11, 0, "wildnature:beech_branch[down=false,east=true,north=false,south=true,up=false,waterlogged=false,west=true]");
        Block(0, 11, 0, "wildnature:beech_branch[down=true,east=true,north=true,south=false,up=true,waterlogged=false,west=true]");
        Block(1, 11, 0, "wildnature:beech_leaves[distance=7,persistent=true]");
        Block(0, 12, 0, "wildnature:beech_branch[down=true,east=true,north=true,south=true,up=true,waterlogged=false,west=false]");
        ...
        Block(0, 13, 0, "wildnature:beech_branch[down=true,east=true,north=true,south=true,up=false,waterlogged=false,west=true]");
        Block(1, 13, 0, "wildnature:beech_branch[down=true,east=true,north=false,south=false,up=true,waterlogged=false,west=true]");
        Block(2, 13, 0, "wildnature:beech_leaves[distance=7,persistent=true]");
        ...
        Block(0, 12, 1, "wildnature:beech_branch[down=false,east=true,north=true,south=true,up=true,waterlogged=false,west=false]");
        Block(1, 12, 1, "wildnature:beech_leaves[distance=7,persistent=true]");
        Block(0, 13, 1, "wildnature:beech_leaves[distance=7,persistent=true]");
        Block(0, 12, 2, "wildnature:beech_leaves[distance=7,persistent=true]");
