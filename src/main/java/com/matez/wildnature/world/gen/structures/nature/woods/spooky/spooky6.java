...
public class spooky6 extends SchemFeature {
    public spooky6() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(-1, 2, -2, "minecraft:cobweb");
        Block(0, 2, -2, "wildnature:lightning_bug[facing=north]");
        ...
        Block(2, 1, -1, "wildnature:lightning_bug[facing=east]");
