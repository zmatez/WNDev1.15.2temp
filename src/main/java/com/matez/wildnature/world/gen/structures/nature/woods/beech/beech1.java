...
public class beech1 extends SchemFeature {
    public beech1() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(0, 10, -1, "wildnature:beech_branch[down=true,east=true,north=true,south=true,up=true,waterlogged=false,west=true]");
        Block(1, 10, -1, "wildnature:beech_leaves[distance=7,persistent=true]");
        ...
        Block(0, 9, 0, "wildnature:beech_branch[down=true,east=false,north=true,south=true,up=true,waterlogged=false,west=false]");
        Block(-1, 10, 0, "wildnature:beech_branch[down=false,east=true,north=true,south=false,up=true,waterlogged=false,west=false]");
        Block(0, 10, 0, "wildnature:beech_branch[down=true,east=true,north=true,south=true,up=true,waterlogged=false,west=true]");
        Block(1, 10, 0, "wildnature:beech_branch[down=false,east=false,north=true,south=false,up=true,waterlogged=false,west=true]");
        Block(-1, 11, 0, "wildnature:beech_leaves[distance=7,persistent=true]");
        Block(0, 11, 0, "wildnature:beech_branch[down=true,east=true,north=true,south=false,up=false,waterlogged=false,west=true]");
        Block(1, 11, 0, "wildnature:beech_leaves[distance=7,persistent=true]");
