...
public class WNBirchScrubs extends WNBiome {
    public WNBirchScrubs(String name) {
        ...
        WNBiomeFeatures.addBlob(this, Blocks.STONE.getDefaultState(), 2, true, false, 3);
    ...
    public int getGrassColor(BlockPos pos) {
        ...
        return customColor(noise, -0.1D, 0x97D010, 0x7FC536);
    }
