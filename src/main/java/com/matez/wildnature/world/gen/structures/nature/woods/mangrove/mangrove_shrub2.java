...
public class mangrove_shrub2 extends SchemFeature {
    public mangrove_shrub2() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(0, 1, 0, "wildnature:mangrove_branch[down=true,east=true,north=false,south=true,up=false,waterlogged=false,west=true]");
        ...
        Block(1, 2, 0, "wildnature:mangrove_branch[down=true,east=false,north=false,south=false,up=true,waterlogged=false,west=false]");
        Block(-1, 3, 0, "wildnature:mangrove_branch[down=true,east=false,north=false,south=false,up=true,waterlogged=false,west=false]");
        Block(1, 3, 0, "wildnature:mangrove_leaves[distance=7,persistent=true]");
        Block(-1, 4, 0, "wildnature:mangrove_leaves[distance=7,persistent=true]");
