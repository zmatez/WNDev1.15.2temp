...
public class pointy_birch1 extends SchemFeature {
    public pointy_birch1() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(1, 7, -1, "minecraft:birch_leaves[distance=3,persistent=true]");
        Block(0, 8, -1, "minecraft:birch_leaves[distance=3,persistent=true]");
        ...
        Block(1, 8, 0, "minecraft:birch_leaves[distance=3,persistent=true]");
        Block(0, 9, 0, "minecraft:birch_leaves[distance=3,persistent=true]");
        Block(0, 3, 1, "minecraft:birch_leaves[distance=1,persistent=true]");
        Block(-1, 4, 1, "minecraft:birch_leaves[distance=2,persistent=true]");
        Block(0, 4, 1, "minecraft:birch_leaves[distance=1,persistent=true]");
        Block(1, 4, 1, "minecraft:birch_leaves[distance=2,persistent=true]");
