...
public class pointy_oak_5 extends SchemFeature {
    public pointy_oak_5() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(1, 7, -1, "minecraft:oak_leaves[distance=3,persistent=true]");
        Block(2, 7, -1, "minecraft:oak_leaves[distance=4,persistent=true]");
