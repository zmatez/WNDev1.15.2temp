...
public class spooky13 extends SchemFeature {
    public spooky13() {
        super();
    ...
    public Set<BlockPos> setBlocks() {
        ...
        Block(0, 4, -4, "minecraft:dark_oak_leaves[distance=5,persistent=true]");
        Block(-1, 5, -4, "minecraft:dark_oak_leaves[distance=5,persistent=true]");
        Block(0, 5, -4, "minecraft:dark_oak_leaves[distance=4,persistent=true]");
        Block(1, 5, -4, "minecraft:dark_oak_leaves[distance=4,persistent=true]");
        Block(0, 4, -3, "minecraft:cobweb");
        Block(-2, 5, -3, "minecraft:dark_oak_leaves[distance=5,persistent=true]");
        Block(-1, 5, -3, "minecraft:dark_oak_leaves[distance=4,persistent=true]");
        Block(0, 5, -3, "minecraft:dark_oak_leaves[distance=3,persistent=true]");
        ...
        Block(0, 2, -2, "wildnature:lightning_bug[facing=up]");
        Block(-3, 5, -2, "minecraft:dark_oak_leaves[distance=5,persistent=true]");
        ...
        Block(0, 6, -2, "minecraft:dark_oak_leaves[distance=3,persistent=true]");
        Block(0, 1, -1, "minecraft:dark_oak_log[axis=z]");
        Block(0, 2, -1, "minecraft:dark_oak_log[axis=z]");
        Block(2, 4, -1, "minecraft:cobweb");
        Block(3, 4, -1, "minecraft:dark_oak_leaves[distance=4,persistent=true]");
        ...
        Block(4, 5, -1, "minecraft:dark_oak_leaves[distance=4,persistent=true]");
        ...
        Block(-2, 2, 0, "wildnature:lightning_bug[facing=west]");
        ...
        Block(2, 4, 0, "minecraft:dark_oak_log[axis=x]");
        ...
        Block(4, 5, 0, "minecraft:dark_oak_leaves[distance=3,persistent=true]");
        Block(-2, 6, 0, "minecraft:dark_oak_leaves[distance=3,persistent=true]");
        ...
        Block(2, 6, 0, "minecraft:dark_oak_leaves[distance=2,persistent=true]");
        Block(3, 6, 0, "minecraft:cobweb");
        ...
        Block(2, 2, 1, "wildnature:lightning_bug[facing=east]");
        ...
        Block(4, 5, 1, "minecraft:dark_oak_leaves[distance=3,persistent=true]");
        ...
        Block(2, 6, 1, "minecraft:dark_oak_leaves[distance=2,persistent=true]");
        Block(0, 1, 2, "minecraft:dark_oak_log[axis=y]");
        Block(2, 1, 2, "minecraft:dark_oak_log[axis=z]");
        Block(0, 2, 2, "wildnature:lightning_bug[facing=up]");
        Block(1, 4, 2, "minecraft:dark_oak_log[axis=z]");
        Block(2, 4, 2, "minecraft:cobweb");
        Block(3, 4, 2, "minecraft:dark_oak_leaves[distance=4,persistent=true]");
        Block(-3, 5, 2, "minecraft:dark_oak_leaves[distance=4,persistent=true]");
        Block(-2, 5, 2, "minecraft:dark_oak_leaves[distance=3,persistent=true]");
        Block(-1, 5, 2, "minecraft:dark_oak_leaves[distance=2,persistent=true]");
        ...
        Block(4, 5, 2, "minecraft:dark_oak_leaves[distance=4,persistent=true]");
        Block(0, 6, 2, "minecraft:dark_oak_leaves[distance=2,persistent=true]");
        Block(2, 6, 2, "minecraft:dark_oak_leaves[distance=3,persistent=true]");
        Block(1, 4, 3, "minecraft:dark_oak_leaves[distance=1,persistent=true]");
        Block(-2, 5, 3, "minecraft:dark_oak_leaves[distance=4,persistent=true]");
        Block(-1, 5, 3, "minecraft:dark_oak_leaves[distance=3,persistent=true]");
        ...
        Block(0, 6, 3, "minecraft:cobweb");
        Block(-1, 5, 4, "minecraft:dark_oak_leaves[distance=4,persistent=true]");
        Block(0, 5, 4, "minecraft:dark_oak_leaves[distance=3,persistent=true]");
        Block(1, 5, 4, "minecraft:dark_oak_leaves[distance=3,persistent=true]");
        Block(2, 5, 4, "minecraft:dark_oak_leaves[distance=4,persistent=true]");
